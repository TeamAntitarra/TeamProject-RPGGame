...
namespace RPGGame.UI
{
    public class PaintBrush : IPaintInterface
    {
        ...
        private const string EltembloImagePath = "../../Images/eltemblo.png";
        ...
        public void LoadResources()
        {
            ...
            this.EltembloImage = Image.FromFile(EltembloImagePath);
        }
